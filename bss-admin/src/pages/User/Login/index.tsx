...
import {postAccountLogin} from "@/services/backend/adminAccountController";
...
const Login: React.FC = () => {
  ...
  const handleSubmit = async (values: API.LoginForm) => {
    try {
      // 登录
      const res = await postAccountLogin({ ...values });
        ...
        >
          ...
          <>
            ...
            <ProFormText.Password
              ...
              placeholder={intl.formatMessage({
                id: 'pages.login.authCode.placeholder',
                defaultMessage: 'Auth code (if enabled):',
              })}
              rules={[
                {
                  required: false,
